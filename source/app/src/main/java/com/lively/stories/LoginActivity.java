...
public class LoginActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		forgot_txt.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				subject = "[IMP] Password Reset Request";
				body = "Hello,\n This is a user from your application Lively! This is to inform you that I have lost my account access because of forgetting the password of my account! I need assistance, please help me! I assure you that I have the registered email address at this time!\n Thanking You,\n {Your Name}".concat("\n\n This is the email address of the account I am logged into!".concat(""));
				Intent emailIntent = new Intent(Intent.ACTION_SENDTO);
				emailIntent.setData(Uri.parse("mailto:nexogenofficial@gmail.com")); // only email apps handle this
		...
		sign_in_button.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (username_edittext.getText().toString().equals("")) {
					username_edittext.setError("Registered Email is empty!");
				} else {
					if (pass_edittext.getText().toString().equals("")) {
						pass_edittext.setError("Password of the Email is empty!");
					} else {
						...
						trying = true;
						fauth.signInWithEmailAndPassword(username_edittext.getText().toString(), pass_edittext.getText().toString()).addOnCompleteListener(LoginActivity.this, _fauth_sign_in_listener);
					}
				}
			}
		});
		...
		username_edittext.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				...
				if (sign_in_button.getVisibility() == View.GONE) {
		...
		sign_up_txt.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				to_create_account.putExtra("from login", "true");
		...
		_fauth_sign_in_listener = new OnCompleteListener<AuthResult>() {
			...
			public void onComplete(Task<AuthResult> _param1) {
				...
				final String _errorMessage = _param1.getException() != null ? _param1.getException().getMessage() : "";
				if (_success) {
					startActivity(new Intent(LoginActivity.this, HomeActivity.class)); Animatoo.animateSlideLeft(LoginActivity.this);
					finish();
				} else {
					if (_errorMessage.equals("An internal error has occurred. [ INVALID_LOGIN_CREDENTIALS ]")) {
						SketchwareUtil.showMessage(getApplicationContext(), "Please double-check the Email or Password");
	...
	public void _ui_design() {
		sign_in_txt.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/poppins_bold.ttf"), 0);
		...
		forgot_txt.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/poppins_medium.ttf"), 1);
		dont_txt.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/poppins_medium.ttf"), 0);
		sign_up_txt.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/poppins_medium.ttf"), 1);
		...
		_set_radius(main_background, "#FFFFFF", 60, 60, 060, 060);
		...
		_set_radius_with_ripple(sign_in_button, "#212121", 30, 0, "#000000", true);
